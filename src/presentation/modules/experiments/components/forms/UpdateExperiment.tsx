...
import { ExperimentField, ExperimentStatus, IExperiment } from "@/core/types/entities";
        ...
        onError(errorResponse) {
          ...
          if (fieldErrors) {
            Object.entries(fieldErrors).forEach(([key, message]) => {
              setFieldError(key as keyof ExperimentFormData, { message });
            });
          }
  ...
  return (
    <FormWrapper isLoading={isPending}>
      <form
        ...
        className="max-w-lg mx-auto space-y-4 py-6 rounded-lg"
      >
